...
<CardGroup className=''>
  <Card>
    <Card.Body>
      ...
      <Card.Text>
      Browse the Re-Art collection and favorite any pieces that catch your eye. A Monet? A George Condo? The choice is–always–yours.
      </Card.Text>
      <Card.Text>
      Update your profile preferences for a curated collection based on your taste.
      </Card.Text>
    </Card.Body>
    <Card.Footer>
